...
declare class CompiledProtodef {
  ...
  public write (value: unknown, buffer: unknown, cursor: unknown, type: unknown): unknown
  ...
  public parsePacketBuffer (type: unknown, buffer: unknown, offset: number): unknown
}
...
declare module "protodef" {
  ...
  class ProtoDef {
    ...
    public addDefaultTypes(): void
    public addProtocol(protocolData: unknown, path: unknown): void
    public addType(name: unknown, functions: unknown, validate: boolean): void
    public addTypes(types: unknown): void
    public setVariable(key: unknown, value: unknown): void
    public read(buffer: Buffer, cursor: unknown, _fieldInfo: unknown, rootNodes: unknown): unknown
    public write (value: unknown, buffer: Buffer, offset: number, _fieldInfo:unknown, rootNode: unknown): unknown
    public sizeOf (value: unknown, _fieldInfo: unknown, rootNode:unknown): unknown
    public createPacketBuffer (type: unknown, packet: unknown): unknown
    public parsePacketBuffer (type: unknown, buffer: Buffer, offset: number): unknown
  }
  ...
  const utils: {
    ...
    getCount (buffer: unknown, offset: unknown, options: unknown, rootNode: unknown): unknown
    sendCount (len: unknown, buffer: unknown, offset: unknown, options: unknown, rootNode: unknown): unknown
